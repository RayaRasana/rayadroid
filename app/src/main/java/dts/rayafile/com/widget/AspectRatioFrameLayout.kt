...
package dts.rayafile.com.widget
...
import dts.rayafile.com.compat.obtainStyledAttributesCompat
import dts.rayafile.com.compat.use
...
class AspectRatioFrameLayout @JvmOverloads constructor(
    ...
    var ratio: Float = context.obtainStyledAttributesCompat(
        ...
        it.getFloat(R.styleable.AspectRatioFrameLayout_aspectRatio, 0f)
    }
        set(value) {
            if (field == value) {
                return
