...
public class FileSyncService extends Service {
     ...
     * <pre>
     * {@code
     * /storage/emulated/0/Android/media/dts.rayafile.com(.debug)/Seafile
     * /storage/emulated/0/Android/media/dts.rayafile.com(.debug)
    ...
    public void initIgnorePath() {
        ...
        // /storage/emulated/0/Android/media/dts.rayafile.com
    ...
    private void doBackup(String action, File file) {
        // The file has changed: /storage/emulated/0/Android/media/dts.rayafile.com/Seafile
